...
延世コーパスの概要については[연세 말뭉치（延世コーパス）の使い方](../yonsei)を参照のこと．
...
> 文節を超えた検索を行いたい場合は，別の文書「[連語の検索](..:yonsei:written_2)」を参照してください．
...
文節の検索については以上です．次は[「연어（連語）」の検索](..:yonsei:written_2)をどうぞ．
